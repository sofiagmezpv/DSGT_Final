...
public class PackageService {
    ...
    public Package getPackageFromId(int id) {
        ...
        Supplier supplierA = new Supplier(webClientBuilder, 1234,"Supplier A", "http://127.0.0.1:8100/rest");
        Supplier supplierB = new Supplier(webClientBuilder, 1234,"Supplier B", "http://127.0.0.1:8200/rest");
